...
public class SettingsActivity extends PreferenceActivity {
    ...
    private static Preference.OnPreferenceChangeListener sBindPreferenceSummaryToValueListener = new Preference.OnPreferenceChangeListener() {
        ...
        public boolean onPreferenceChange(Preference preference, Object value) {
            ...
            if (preference instanceof ListPreference) {
                ...
                // DUE TO THE ELSE STATEMENT WE NEED AN EMPTY IF STATEMENT HERE ... WE DONT WANT ColorPreference TO UPDATE THE SUMMARY TO ITS VALUE
            } else {
    ...
    protected boolean isValidFragment(String fragmentName) {
        return PreferenceFragment.class.getName().equals(fragmentName)
                ...
                || RemoteControlPreferenceFragment.class.getName().equals(fragmentName);
    }
    ...
    /**
     * This fragment shows remote control preferences only. It is used when the
     * activity is showing a two-pane settings UI.
     */
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public static class RemoteControlPreferenceFragment extends PreferenceFragment {
        @Override
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            addPreferencesFromResource(R.xml.pref_joy);
            setHasOptionsMenu(true);
            ...
            // updated to reflect the new value, per the Android Design
            // guidelines.
            bindPreferenceSummaryToValue(findPreference("joy_driveinterval"));
            bindPreferenceSummaryToValue(findPreference("joy_turninterval"));
        }
